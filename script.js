...
function main(){
      ...
      function init() {
        ...
        // specify a model URL
         const modelUrl =
          "https://raw.githubusercontent.com/vrarmrbaskar/assetsRepo/main/independenceday.gltf";
        ...
        loader.load(
          ...
          function(gltf) {
            ...
            // you can optionally change the position of the model
             gltf.scene.position.z = -1; // negative Z moves the model in the opposite direction the camera is facing
             gltf.scene.position.y = 0; // positive Y moves the model up
